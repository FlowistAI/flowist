...
import { Input, Radio, RadioGroup, FormLabel, FormControl, Checkbox } from '@mui/joy';
import { SystemSection } from '../../hooks/Settings/types';
...
export const SystemSettingsForm: FC<SystemSettingsFormProps> = forwardRef(({ initialValues, validationSchema, onSubmit }, refs) => {
        ...
        <form onSubmit={formik.handleSubmit}>
            ...
            <FormControl component="fieldset" style={{ marginTop: '20px' }}>
                ...
                <Checkbox
                    ...
                    onChange={(e) => formik.setFieldValue('autoSave', e.target.checked)}
                    color="primary"
                />
            </FormControl>
        </form>
