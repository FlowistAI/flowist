...
import { TextToSpeechNodeData, TextToSpeechSession } from './text-to-speech-node.types'
...
export class TextToSpeechNodeService implements SubManager<AppNodeTypes.TextToSpeech> {
